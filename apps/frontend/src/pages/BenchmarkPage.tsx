...
export function BenchmarkPage() {
  ...
  return <section className="pb-8">
    ...
    <div className="mt-7 overflow-hidden rounded-lg border border-cyan-400/20 bg-[radial-gradient(ellipse_at_top_left,_rgba(34,211,238,0.15),transparent_53%)] p-6 shadow-2xl shadow-slate-950/20">
